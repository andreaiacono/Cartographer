...
class ConfigurationPanel(wx.Panel):
    ...
    def __init__(self, parent, window_id, cartographer, projection):
        ...
        self.slider_phi1 = wx.Slider(self.panel, minValue=0, maxValue=89, value=30, style=wx.SL_HORIZONTAL)
        self.slider_phi2 = wx.Slider(self.panel, minValue=0, maxValue=89, value=60, style=wx.SL_HORIZONTAL)
